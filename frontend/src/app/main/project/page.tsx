  ...
  return (
    <div className={styles.projectListContainer}>
      <div className={styles.projectListHeader}>
        ...
        <button
          onClick={() => router.push("/main/project/create")}
        ...
        {projects.map((proj) => (
          <div key={proj._id} className={styles.projectCard}>
            ...
            <div className={styles.projectMeta}>
              ...
              <p>
                <strong>Priority:</strong> {proj.priority}
              </p>
              <p>
                <strong>Assignee:</strong> {proj.assignee}
              </p>
              <p>
                <strong>Assigned By:</strong> {proj.assignedBy}
              </p>
              <p>
                <strong>Tags:</strong> {proj.tags.join(", ")}
              </p>
            </div>
            <div className={styles.projectActions}>
              <button
                onClick={() =>
                  router.push(`/main/project/create?id=${proj._id}`)
                }
